export const TEST_DAT_ORG_REPO_EXTENDED_ITEM_2_COLLECTED = [
  {
    ...
    watchers: { totalCount: 101 },
    stargazers: { totalCount: 1501 },
    forks: { totalCount: 1391 },
    issues: { totalCount: 33 },
    pullRequests: { totalCount: 26 },
    openPrs: { totalCount: 26 },
    lastPr: {
      nodes: [
        {
  ...
  },
  {
    ...
    languages: {
      edges: [
        ...
        { node: { name: 'HTML' } },
        { node: { name: 'PowerShell' } }
      ]
    },
    watchers: { totalCount: 109 },
    stargazers: { totalCount: 1142 },
    forks: { totalCount: 850 },
  ...
  },
  {
    ...
    watchers: { totalCount: 109 },
    stargazers: { totalCount: 769 },
    forks: { totalCount: 645 },
    issues: { totalCount: 8 },
    pullRequests: { totalCount: 7 },
    openPrs: { totalCount: 7 },
    lastPr: {
  ...
  },
  {
    ...
    stargazers: { totalCount: 552 },
    forks: { totalCount: 420 },
      ...
      edges: [
        {
          node: {
            ...
            title: 'A similar issue to not getting any response from /ackaud ',
  ...
  },
  {
    ...
    watchers: { totalCount: 44 },
    stargazers: { totalCount: 431 },
    forks: { totalCount: 334 },
          ...
          edges: [
            {
              node: {
                author: {
                  ...
                  email: '36256675+balakrishnaakuleti@users.noreply.github.com',
